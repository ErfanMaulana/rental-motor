            ...
            <form method="GET" action="{{ route('pemilik.revenue.report') }}">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" name="month">
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" name="year">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('pemilik.revenue.report') }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
